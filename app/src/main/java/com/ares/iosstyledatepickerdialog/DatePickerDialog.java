...
public class DatePickerDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder(Context context, boolean isgone, boolean isyear, int maxyear, int minyear) {
        ...
        public DatePickerDialog create() {
            ...
            if (isgone) {
                FrameLayout frameLayout = (FrameLayout) view.findViewById(R.id.day_fl);
                FrameLayout fl_view_center = (FrameLayout) view.findViewById(R.id.fl_view_center);
                frameLayout.setVisibility(View.GONE);
                fl_view_center.setVisibility(View.GONE);
            }
            if(isyear){   //如果是true  就隐藏
                FrameLayout framemonth = (FrameLayout) view.findViewById(R.id.month_fl);
                FrameLayout fl_year_center = (FrameLayout) view.findViewById(R.id.fl_line_month);
                framemonth.setVisibility(View.GONE);
                fl_year_center.setVisibility(View.GONE);
            }
